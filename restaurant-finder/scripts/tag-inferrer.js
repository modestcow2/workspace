...
const RULES = [
  ...
  { keywords: ['전골', '샤브샤브', '부대찌개'],
    tags: { flavor: ['짠'], texture: ['헤비한'], cooking: ['국물·찜'], cuisine: ['한식'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['국밥·탕·찌개'] },
    price: '₩₩', menu: ['전골'] },

  // 한식 - 구이/고기류
  { keywords: ['갈비', '갈비찜'],
    tags: { flavor: ['단', '기름진'], texture: ['부드러운', '헤비한'], cooking: ['구이·볶음'], cuisine: ['한식'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['구이'] },
    price: '₩₩₩', menu: ['갈비'] },
  { keywords: ['삼겹살', '목살', '돼지고기', '고깃집', '구이', '소고기', '한우'],
    tags: { flavor: ['기름진'], texture: ['헤비한'], cooking: ['구이·볶음'], cuisine: ['한식'], temp: ['뜨끈한'], occasion: ['사교·회식', '안주'], health: [], foodType: ['구이'] },
    price: '₩₩₩', menu: ['고기구이'] },
  { keywords: ['불고기'],
    tags: { flavor: ['단', '기름진'], texture: ['부드러운'], cooking: ['구이·볶음'], cuisine: ['한식'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['구이'] },
    price: '₩₩', menu: ['불고기'] },
  { keywords: ['보쌈'],
    tags: { flavor: ['담백 깔끔'], texture: ['부드러운', '헤비한'], cooking: ['국물·찜'], cuisine: ['한식'], temp: ['뜨끈한'], occasion: ['사교·회식', '안주'], health: [], foodType: ['족발·보쌈'] },
    price: '₩₩', menu: ['보쌈'] },
  { keywords: ['족발'],
    tags: { flavor: ['기름진'], texture: ['쫄깃한', '헤비한'], cooking: ['국물·찜'], cuisine: ['한식'], temp: ['뜨끈한'], occasion: ['사교·회식', '안주'], health: [], foodType: ['족발·보쌈'] },
    price: '₩₩', menu: ['족발'] },
  ...
  { keywords: ['비빔밥', '돌솥밥'],
    ...
    price: '₩', menu: ['비빔밥'] },
  { keywords: ['한정식'],
    tags: { flavor: ['담백 깔끔'], texture: ['가벼운'], cooking: ['국물·찜'], cuisine: ['한식'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: ['저자극'], foodType: ['백반·가정식'] },
    price: '₩₩₩', menu: ['한정식'] },
  { keywords: ['백반', '정식', '가정식'],
  ...
  { keywords: ['떡볶이', '분식'],
    ...
    price: '₩', menu: ['떡볶이'] },
  { keywords: ['순대'],
    tags: { flavor: ['담백 깔끔'], texture: ['쫄깃한', '부드러운'], cooking: ['국물·찜'], cuisine: ['한식'], temp: ['뜨끈한'], occasion: ['혼밥', '안주'], health: [], foodType: ['분식'] },
    price: '₩', menu: ['순대'] },
  { keywords: ['만두'],
  ...
  { keywords: ['치킨', '닭강정', '후라이드', '양념치킨'],
    tags: { flavor: ['기름진'], texture: ['바삭한'], cooking: ['튀김'], cuisine: ['한식'], temp: ['뜨끈한'], occasion: ['사교·회식', '안주'], health: [], foodType: ['치킨'] },
    price: '₩₩', menu: ['치킨'] },
  ...
  { keywords: ['짜장면', '짬뽕', '중국집', '중화요리'],
    ...
    price: '₩', menu: ['짜장면', '짬뽕'] },
  { keywords: ['마라탕', '마라', '훠궈'],
    tags: { flavor: ['매운', '기름진'], texture: ['헤비한'], cooking: ['국물·찜'], cuisine: ['중식'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['마라·훠궈'] },
    price: '₩₩', menu: ['마라탕'] },
  { keywords: ['딤섬'],
    tags: { flavor: ['담백 깔끔'], texture: ['부드러운'], cooking: ['국물·찜'], cuisine: ['중식'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['중식'] },
    price: '₩₩', menu: ['딤섬'] },

  // 일식
  { keywords: ['초밥', '스시', '오마카세'],
    tags: { flavor: ['담백 깔끔', '감칠맛'], texture: ['부드러운'], cooking: ['생식·무침'], cuisine: ['일식'], temp: ['차가운'], occasion: ['사교·회식'], health: [], foodType: ['일식·초밥'] },
    price: '₩₩₩', menu: ['초밥'] },
  { keywords: ['라멘', '라면'],
  ...
  { keywords: ['우동', '소바'],
    ...
    price: '₩', menu: ['우동'] },
  { keywords: ['사시미', '회', '횟집'],
    tags: { flavor: ['담백 깔끔'], texture: ['아삭한'], cooking: ['생식·무침'], cuisine: ['일식'], temp: ['차가운'], occasion: ['사교·회식', '안주'], health: [], foodType: ['일식·초밥'] },
    price: '₩₩₩', menu: ['회'] },

  // 양식
  { keywords: ['이탈리아음식', '이탈리안', '이탈리아'],
    tags: { flavor: ['기름진'], texture: ['쫄깃한'], cooking: ['면류·파스타'], cuisine: ['이탈리안'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['피자·파스타'] },
    price: '₩₩', menu: ['이탈리안'] },
  { keywords: ['프랑스음식', '프렌치'],
    tags: { flavor: ['기름진', '감칠맛'], texture: ['부드러운'], cooking: ['오븐·화덕'], cuisine: ['양식'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['스테이크·양식'] },
    price: '₩₩₩', menu: ['프렌치'] },
  { keywords: ['스페인음식'],
    tags: { flavor: ['기름진', '짠'], texture: ['가벼운'], cooking: ['구이·볶음'], cuisine: ['양식'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['스테이크·양식'] },
    price: '₩₩', menu: ['스페인요리'] },
  { keywords: ['멕시코', '남미음식', '타코'],
    tags: { flavor: ['매운', '기름진'], texture: ['바삭한'], cooking: ['구이·볶음'], cuisine: ['기타지역'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['멕시코·남미'] },
    price: '₩₩', menu: ['멕시코요리'] },
  { keywords: ['패밀리레스토랑'],
    tags: { flavor: ['기름진'], texture: ['헤비한'], cooking: ['구이·볶음'], cuisine: ['양식'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['스테이크·양식'] },
    price: '₩₩', menu: ['양식'] },
  { keywords: ['파스타', '스파게티'],
    tags: { flavor: ['기름진'], texture: ['쫄깃한'], cooking: ['면류·파스타'], cuisine: ['이탈리안'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['피자·파스타'] },
    price: '₩₩', menu: ['파스타'] },
  { keywords: ['피자'],
    tags: { flavor: ['기름진', '짠'], texture: ['바삭한', '쫄깃한'], cooking: ['오븐·화덕'], cuisine: ['이탈리안'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['피자·파스타'] },
    price: '₩₩', menu: ['피자'] },
  { keywords: ['스테이크', '립'],
    tags: { flavor: ['기름진', '감칠맛'], texture: ['부드러운', '헤비한'], cooking: ['구이·볶음'], cuisine: ['양식'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: ['벌크업·보양'], foodType: ['스테이크·양식'] },
    price: '₩₩₩', menu: ['스테이크'] },
  { keywords: ['햄버거', '버거'],
  ...
  { keywords: ['카페', '베이커리', '빵', '디저트', '케이크', '마카롱', '와플', '크로플', '도넛', '아이스크림', '젤라토', '타르트'],
    tags: { flavor: ['단'], texture: ['부드러운', '가벼운'], cooking: ['디저트·베이킹'], cuisine: ['기타지역'], temp: ['차가운'], occasion: ['혼밥'], health: [], foodType: ['카페·디저트'] },
    price: '₩₩', menu: ['디저트'] },
  { keywords: ['샐러드', '포케'],
  ...
  // 퓨전
  { keywords: ['퓨전음식', '퓨전'],
    tags: { flavor: ['기름진', '감칠맛'], texture: ['가벼운'], cooking: ['구이·볶음'], cuisine: ['퓨전'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [], foodType: ['퓨전'] },
    price: '₩₩', menu: ['퓨전'] },
