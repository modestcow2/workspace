...
const RULES = [
  ...
  { keywords: ['멕시코', '남미음식', '타코'],
    tags: { flavor: ['매운', '기름진'], texture: ['바삭한'], cooking: ['구이·볶음'], cuisine: ['기타지역'], temp: ['뜨끈한'], occasion: ['사교·회식'], health: [] },
    price: '₩₩', menu: ['멕시코요리'] },
  { keywords: ['패밀리레스토랑'],
  ...
  { keywords: ['카페', '베이커리', '빵', '디저트', '케이크', '마카롱', '와플', '크로플', '도넛', '아이스크림', '젤라토', '타르트'],
    tags: { flavor: ['단'], texture: ['부드러운', '가벼운'], cooking: ['디저트·베이킹'], cuisine: ['기타지역'], temp: ['차가운'], occasion: ['혼밥'], health: [] },
    price: '₩₩', menu: ['디저트'] },
  { keywords: ['샐러드', '포케'],
  ...
  // 에스닉
  { keywords: ['베트남음식'],
    tags: { flavor: ['새콤한', '담백 깔끔'], texture: ['쫄깃한', '가벼운'], cooking: ['면류·파스타'], cuisine: ['동남아'], temp: ['뜨끈한'], occasion: ['혼밥'], health: [] },
    price: '₩', menu: ['베트남요리'] },
  { keywords: ['태국음식'],
    tags: { flavor: ['매운', '새콤한'], texture: ['가벼운'], cooking: ['구이·볶음'], cuisine: ['동남아'], temp: ['뜨끈한'], occasion: ['혼밥'], health: [] },
    price: '₩₩', menu: ['태국요리'] },
  { keywords: ['인도음식'],
    tags: { flavor: ['매운'], texture: ['부드러운', '헤비한'], cooking: ['국물·찜'], cuisine: ['기타지역'], temp: ['뜨끈한'], occasion: ['혼밥'], health: [] },
    price: '₩₩', menu: ['인도요리'] },
